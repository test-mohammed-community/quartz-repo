...
13. git --all --graph
![git graph](imgs/git&github/hands-on/git-graph.png)
...
![git merge success](imgs/git&github/hands-on/git-merge-success.png)
4. merge the sub_function branch into the master branch using `git merge feature/sub`
5. display the conflict
![git merge conflict](imgs/git&github/hands-on/git-merge-conflict.png)
...
![git merge conflict](imgs/git&github/hands-on/git-merge-conflict-resolved.png)