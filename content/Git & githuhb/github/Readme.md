...
1. In the upper-right corner of any page, use the drop-down menu, and select New repository.
    ...
    ![repo-create](imgs/git&github/github/repo-create.png)
...
![Creating a repository](imgs/git&github/github/createRepo.png)

![OSC repo](imgs/git&github/github/osc-repo.png)

### Git Repository URL

To clone your repo you can find its URL here :

![Repo URL](imgs/git&github/github/repo-url.png)
...
![Fork](imgs/git&github/github/forkRepo1.png)

![Fork](imgs/git&github/github/forkRepo2.png)

![Fork](imgs/git&github/github/forkRepo3.png)
