...
![showing_inodes](imgs/creating-links/showing_inodes.png) 
...
![meme](imgs/creating-links/meme1.jpeg)
...
![](imgs/creating-links/hard-link.png)
...
![](imgs/creating-links/hard_link.png)
...
![Limitations of Hard Links](imgs/creating-links/Limitations-of-Hard%20Links.png)
...
![](imgs/creating-links/soft-link.png)
...
![](imgs/creating-links/soft_link.png)
...
![](imgs/creating-links/unlink.png)

And since a link is a file after all, you can also delete it with ```rm```.

**Example:**

![](imgs/creating-links/remove%20link.png)
...
![](imgs/creating-links/dangling-soft-link.png)
