...
<img src="imgs/cli/terminal.jpg" width="500" height="500">
...
<img src="imgs/cli/terminal-emulator.png">
...
![prompt1](imgs/cli/command_line_prompt.jpg) 
![prompt2](imgs/cli/command_line_prompt-2.jpg)
...
![command-line-syntax](imgs/cli/command_line_syntax.jpg)
...
![ls -l](imgs/cli/ls-l_command.jpg)
...
![File Systems](imgs/cli/filesystem.png)
...
![Windows Directory Structure](imgs/cli/windows_directory_structure.png)
...
![The Linux File Structure](imgs/cli/linux-file-structure.png)
...
![Linux-Directory-Structure](imgs/cli/Linux-Directory-Structure.png)
...
![Root Directory](imgs/cli/ls_root.jpg)
...
![Relative and absolute paths](imgs/cli/relative_and_absolute_path.png)
...
![Example](imgs/cli/example_absolute_and_relative_path.png)
...
![File Type](imgs/cli/file-types1.png)
![File Type](imgs/cli/file-types2.png)
...
![mkdir](imgs/cli/make-dir.png)

![mkdir](imgs/cli/make-dir-2-words.png)
...
![mkdir -p](imgs/cli/make%20dirssss.png)

Let's check:

![ls](imgs/cli/ls%20-l.png)
...
![tab](imgs/cli/TAB-Completion.png)
...
![Continuing a long command on another line](imgs/cli/Continuing-a-long-command-on-another-line.png)
...
![Command History](imgs/cli/Command-history.png)
