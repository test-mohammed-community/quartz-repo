...
![Conditionals](imgs/shell-scripting/Conditionals.png)
...
![Example](imgs/shell-scripting/checkExistance-script.png)

![Example](imgs/shell-scripting/checkExistance-terminal.png)
...
![Loops](imgs/shell-scripting/Loops.png)
...
![For Loop](imgs/shell-scripting/for-loop-terminal.png)
...
![Example](imgs/shell-scripting/fun-script.png)
![Example](imgs/shell-scripting/fun-terminal.png)
...
![Example](imgs/shell-scripting/addFun-script.png)
![Example](imgs/shell-scripting/add-fun-terminal.png)

# The Fork Bomb 
## :(){:|:&};:

![Meme](imgs/shell-scripting/fork-bomb.png)
...
![The Fork Bomb](imgs/shell-scripting/ForkBomb.png)
