...
![coconut-shell-kernel](imgs/shell-scripting/coconut-shell-kernel.png)
...
![Hello World Script](imgs/shell-scripting/helloWorld-Script.png)

![Hello World Script](imgs/shell-scripting/helloWorld-Script2.png)
...
![Variables on CLI](imgs/shell-scripting/vars-cli.png)

####  Variables on Script

Creating a script that does the same thing :

![Variables on Script](imgs/shell-scripting/nano-vars.png)
...
![Positional Parameter](imgs/shell-scripting/Positional-Parameter.png)

### Example

![Positional Parameters](imgs/shell-scripting/Positional-Parameters.png)
...
![$0](imgs/shell-scripting/name-of-the-shell.png)
...
![Exit Status](imgs/shell-scripting/exit-status.png)
...
![Dollar Underscore](imgs/shell-scripting/dollar-underscore-terminal.png)


![Dollar Underscore](imgs/shell-scripting/dollar-underscore-script.png)

### `$#`

Expands to the **number of positional parameters**, **excluding $0** that was sent to a script.

![$#](imgs/shell-scripting/dollar-hash.png)
...
![$$](imgs/shell-scripting/current-shell-ID.png)
...
![Examples](imgs/shell-scripting/star-and-@-script.png)

![Examples](imgs/shell-scripting/star-and-@-terminal.png)
...
![Examples](imgs/shell-scripting/Arithmetic-Expansion.png)
...
![Examples](imgs/shell-scripting/expr.png)

### `let` Command

Evaluates arithmetic expressions.

![Examples](imgs/shell-scripting/let.png)
...
![Example](imgs/shell-scripting/read-script.png)

![Example](imgs/shell-scripting/read-terminal.png)
...
![Example](imgs/shell-scripting/Local-vs-Global-Variables.png)
...
![Examples](imgs/shell-scripting/Shell-Variables.png)
...
![Comments](imgs/shell-scripting/comments.png)
...
![Example](imgs/shell-scripting/Command-Sub-script.png)

![Example](imgs/shell-scripting/Command-Sub-terminal.png)
