...
- Here is a visual representation showing how to reference records and fields:
   ...
   ![Records and fields](imgs/text-processing/awk/Records-and-fields.png)
...
![Examples](imgs/text-processing/awk/basicExamples.png)
...
![Regex](imgs/text-processing/awk/regex.png)
...
![Relational Expressions](imgs/text-processing/awk/Relational-Expressions.png)
...
![Examples](imgs/text-processing/awk/range-patterns.png)
...
![Examples](imgs/text-processing/awk/Special-Expression-Patterns.png)
...
![Example](imgs/text-processing/awk/Combining-patterns.png)
...
![Examples](imgs/text-processing/awk/variables.png)
...
![Examples](imgs/text-processing/awk/Conditional-If-Statements.png)
