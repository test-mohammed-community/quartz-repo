...
![Basic Regular expressions](imgs/text-processing/regex/Basic-regex.png)
...
![Range of Characters](imgs/text-processing/regex/Range-of-Characters.png)
...
![Examples](imgs/text-processing/regex/Exceptions-in-a-character-set.png)
...
![Examples](imgs/text-processing/regex/Repeating-character-sets.png)
...
![Example](imgs/text-processing/regex/word-boundary.png)
...
![Examples](imgs/text-processing/regex/min-max-number-of-repeats.png)
...
![Examples](imgs/text-processing/regex/Backreferences.png)
...
![Examples](imgs/text-processing/regex/exregex.png)
...
![Examples](imgs/text-processing/regex/Interval-regex.png)
