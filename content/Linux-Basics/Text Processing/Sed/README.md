...
![Example](imgs/text-processing/sed/The-Substitute-Command.png)
...
![Examples](imgs/text-processing/sed/Replacing-strings-eg1.png)
...
![Examples](imgs/text-processing/sed/Replacing-strings-eg2.png)
...
![Example](imgs/text-processing/sed/Replace-on-a-line.png)
...
![Examples](imgs/text-processing/sed/Change-a-line.png)
...
![Examples](imgs/text-processing/sed/Deleting-lines.png)
...
![Examples](imgs/text-processing/sed/matched-string.png)
...
![Examples](imgs/text-processing/sed/Add-a-line.png)
...
![Example](imgs/text-processing/sed/Duplicating-lines.png)
...
![Examples](imgs/text-processing/sed/delimiter.png)
...
![Examples](imgs/text-processing/sed/Running-multiple-sed-commands.png)
...
![Examples](imgs/text-processing/sed/Sed-as-grep.png)
...
![Example](imgs/text-processing/sed/Sed-as-tr.png)
