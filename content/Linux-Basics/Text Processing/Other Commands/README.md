...
![Examples](imgs/text-processing/other-commands/cutExamples.png)
...
![Examples](imgs/text-processing/other-commands/uniq.png)
...
![Examples](imgs/text-processing/other-commands/tr.png)
...
![Examples](imgs/text-processing/other-commands/paste.png)
