...
![Examples](imgs/text-processing/grep/example1.png)

![Examples](imgs/text-processing/grep/example2.png)

![Examples](imgs/text-processing/grep/example3.png)
...
![Example](imgs/text-processing/grep/grep-r.png)
...
![Examples](imgs/text-processing/grep/example4.png)
