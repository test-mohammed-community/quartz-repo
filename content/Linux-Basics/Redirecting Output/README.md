...
<p float="left">
<img src="imgs/redirecting-outputs/doug.jpg" width="384" height="480">
<img src="imgs/redirecting-outputs/ken.jpg" width="384" height="480">
</p>
...
![ls Example](imgs/redirecting-outputs/lsExample.png)

Running ``hello`` or any unknown command or syntax will give an error, thus channeled to stderr:    

![commandNotFound Example](imgs/redirecting-outputs/commandNotFoundExample.png)
...
![Output Redirection Operators](imgs/redirecting-outputs/redirecting-output.png)
...
![IO Redirection](imgs/redirecting-outputs/IORedirectionExample.png)
...
![IO Redirection](imgs/redirecting-outputs/stdErrExample.png)
...
![pipe](imgs/redirecting-outputs/pipe.png)
...
![](imgs/redirecting-outputs/pipe-example.png)
...
![cowsay](imgs/redirecting-outputs/cowsay.png)
...
![tee](imgs/redirecting-outputs/tee-in-the-middle.png)
...
![wc](imgs/redirecting-outputs/wc.png)

You can use it with pipe to count number of files in a directory:

![](imgs/redirecting-outputs/wc-with-pipe.png)
