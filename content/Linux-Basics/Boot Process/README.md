...
![Boot Process](imgs/boot-process/bootProcess.jpeg)
...
![Boot Loader](imgs/boot-process/bootloader.jpg)
...
![PID=1](imgs/boot-process/PID1.png)

On my system, `/sbin/init` is a symlink to `/lib/systemd/systemd`:


![/lib/systemd/systemd](imgs/boot-process/systemd.png)
