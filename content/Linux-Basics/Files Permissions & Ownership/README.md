...
![Permissions](imgs/files-permissions/permissions.png)
...
![ls -l](imgs/files-permissions/ls-long.png)
...
![Example](imgs/files-permissions/chmod-absolute-mode.png)
...
![File permissions](imgs/files-permissions/chmod-symbolic-mode.png)
...
![chown](imgs/files-permissions/chown.png)
...
![chgrp](imgs/files-permissions/chgrp.png)
...
![Groups](imgs/files-permissions/groups.png)
