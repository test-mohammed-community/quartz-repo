...
![id](imgs/dealing-with-users/id.png)
...
![/etc/passwd File](imgs/dealing-with-users/etc-passwd.png)
...
![Example](imgs/dealing-with-users/users-entry.png)
...
![/etc/shadow File](imgs/dealing-with-users/etc-shadow-file.png)
...
![](imgs/dealing-with-users/password-aging.png)

![Fields](imgs/dealing-with-users/etc-shadow-fields.png)
...
![/etc/group File](imgs/dealing-with-users/etc-group-file.png)
...
![Example](imgs/dealing-with-users/group-entry.png)
...
![sudo](imgs/dealing-with-users/sudo.png)
...
![su](imgs/dealing-with-users/su.png)

When root runs `su`, you do not need to enter the user's password.

![](imgs/dealing-with-users/sudo-su.png)
...
![su vs su -](imgs/dealing-with-users/su-.png)
...
![/etc/default/useradd](imgs/dealing-with-users/etc-default-useraddfile.png)
...
![Useradd](imgs/dealing-with-users/useradd.png)
...
![passwd](imgs/dealing-with-users/passwd.png)
...
![groupadd](imgs/dealing-with-users/groupadd.png)
...
![usermod](imgs/dealing-with-users/usermod.png)
...
![userdel](imgs/dealing-with-users/userdel.png)
...
![groupdel](imgs/dealing-with-users/groupdel.png)
